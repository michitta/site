    ...
    <main className="flex flex-col items-center gap-5">
      ...
      <section id="Projects" className="flex flex-col gap-12 max-2xl:px-1 px-16 py-24 items-center text-center">
        <div className="flex flex-col gap-2">
          <h1 className="font-bold text-4xl dark:text-white text-black">{getLangText("en", "DevelopedText")}</h1>
          <p className="font-semibold text-base dark:text-label-2 text-label-2-w">{getLangText("en", "DevelopedDescription")}</p>
        </div>
