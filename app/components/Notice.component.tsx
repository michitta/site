...
export default function NoticeComponent() {
  return (
    <motion.div
      ...
      exit={{ scale: 0, top: -20 }}
      className="absolute max-sm:top-32! top-22 items-center flex gap-3 px-3 py-2 rounded-2xl dark:bg-1-t bg-1-t-w border dark:border-label-5 border-label-5-w backdrop-blur-2xl"
    >
      <NavigationArrowIcon className="dark:fill-white fill-black" size={16} />
      <div className="flex flex-col gap-1">
        <h2 className="font-semibold max-sm:text-xs text-sm dark:text-white text-black">
        ...
        <p className="font-semibold max-sm:text-xs text-sm dark:text-label-2 text-label-2-w">
